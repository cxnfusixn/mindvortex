...
export function emailHtml(lead) {
  ...
  const content = blocks.map((block) => {
    const alignment = /^(Dzień dobry|Pozdrawiam|Moje realizacje:|Instagram:|TikTok:)/.test(block) ? "left" : "justify";
    ...
    return `<tr><td class="pad" style="padding:0 36px 22px;color:#f2f4f3;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;text-align:${alignment};text-align-last:left;hyphens:auto;overflow-wrap:anywhere">${text}</td></tr>`;
  }).join("");
