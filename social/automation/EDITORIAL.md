# Social Studio controls and editorial direction

- Pending posts, Reels and TikTok carousels support Publish now and Remove and generate replacement. Published or uncertain submissions cannot be blindly republished or removed through these actions.
- Publish now queues durable intent; the worker bypasses the scheduled date/hour while preserving account checks, media validation, deduplication and one-time submission. Global pause still applies. Publication is confirmed separately.
