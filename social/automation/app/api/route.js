...
export async function POST(req){
 ...
 if(b.action==='engagement-add'){
  ...
  await pool.query('INSERT INTO social_removed_content(platform,permalink) VALUES($1,$2) ON CONFLICT DO NOTHING',[b.platform,b.permalink]);await event('Owner reported removal from '+b.platform+': '+b.permalink);
 }else if(b.action==='replace-content'){
