...
import {carouselSlots} from './reel-schedule.mjs';
export {carouselSlots} from './reel-schedule.mjs';
...
export async function prepareCarousels(options={}){return locked('tiktok-carousels',async()=>{
 ...
 for(const day of (options.days||carouselSlots(cfg))){
  ...
  content.growth={version:experiment.version,hook:experiment.id};
  const assets=[],hashes=[];
